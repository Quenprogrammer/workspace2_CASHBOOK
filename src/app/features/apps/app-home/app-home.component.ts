...
export class AppHomeComponent {
  ...
  googleProducts=[
    ...
    { name: "Google Drive", sn: "5", link: "https://drive.google.com", image: path + '' },
    { name: "Google Calendar", sn: "6", link: "https://calendar.google.com", image: path + '' },
    { name: "Google Meet", sn: "7", link: "https://meet.google.com", image: path + '' },
    ...
    { name: "Google Sites", sn: "12", link: "https://sites.google.com", image: path + '' },
    ...
    { name: "Google Maps", sn: "18", link: "https://maps.google.com", image: path + '' },
