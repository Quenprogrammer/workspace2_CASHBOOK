...
import {OverviewComponent} from '../../app/features/menu/statistics/overview/overview.component';
...
export class PublicSiteDashboardComponent {
  ...
  drawChart() {
    const canvas = document.getElementById('income') as HTMLCanvasElement;
    if (!canvas) return;
    ...
    const labels = ['D1', 'D2', 'D3',  'D9', 'D10', 'D11', 'D12', 'D13', 'D14', 'D15'];
